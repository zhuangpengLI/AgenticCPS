    ...
    <div class="toolbox-layout">
      ...
      <main class="tool-main">
        <ContentWrap>
          ...
          />
          <UniversalTransferPanel
            v-else-if="activeTool === 'pdd-transfer'"
            locked-platform-code="pdd"
            @promotion="promotionContent = $event"
          />
          <UniversalTransferPanel
            v-else-if="activeTool === 'meituan-waimai-transfer'"
            locked-platform-code="meituan"
            @promotion="promotionContent = $event"
          />
          <ParsePanel
      ...
      <aside v-if="showPromotionEditor" class="result-side">
        <ContentWrap>
...
import { allTools, promotionEditorTools, resolveToolKey, toolGroups, type ToolKey } from './toolboxTools'
...
const currentTool = computed(() => allTools.find((tool) => tool.key === activeTool.value))
const showPromotionEditor = computed(() => promotionEditorTools.includes(activeTool.value))
