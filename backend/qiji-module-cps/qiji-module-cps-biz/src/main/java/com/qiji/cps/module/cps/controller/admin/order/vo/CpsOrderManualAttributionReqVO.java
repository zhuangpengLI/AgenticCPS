...
/** 管理后台 - CPS 订单手动归因 Request VO。 */
@Schema(description = "管理后台 - CPS订单手动归属会员 Request VO")
@Data
public class CpsOrderManualAttributionReqVO {
    ...
    @Schema(description = "请求幂等键", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "manual-attribution-20260903-0001")
    @NotBlank(message = "请求幂等键不能为空")
    @Size(max = 128, message = "请求幂等键长度不能超过128个字符")
    private String idempotencyKey;

    @Schema(description = "人工复核说明", example = "平台订单截图与会员申诉单一致")
