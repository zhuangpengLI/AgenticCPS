...
public class CpsRebateActivitySyncReqVO {
    ...
    @Schema(description = "供应商编码：all/dataoke/haodanku/jutuike，all 表示同步大淘客和好单库", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "all")
    ...
    @Schema(description = "最大同步页数；不传则同步到接口最后一页", example = "1")
