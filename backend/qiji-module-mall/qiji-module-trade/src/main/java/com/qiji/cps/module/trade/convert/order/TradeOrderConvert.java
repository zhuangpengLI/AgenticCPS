package com.qiji.cps.module.trade.convert.order;
...
import com.qiji.cps.framework.common.util.string.StrUtils;
import com.qiji.cps.framework.dict.core.DictFrameworkUtils;
import com.qiji.cps.framework.ip.core.utils.AreaUtils;
...
import com.qiji.cps.module.pay.enums.DictTypeConstants;
import com.qiji.cps.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.qiji.cps.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.qiji.cps.module.product.api.sku.dto.ProductSkuRespDTO;
import com.qiji.cps.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.qiji.cps.module.product.api.spu.dto.ProductSpuRespDTO;
import com.qiji.cps.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.qiji.cps.module.trade.api.order.dto.TradeOrderRespDTO;
import com.qiji.cps.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.qiji.cps.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.qiji.cps.module.trade.controller.admin.order.vo.*;
import com.qiji.cps.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.qiji.cps.module.trade.controller.app.order.vo.*;
import com.qiji.cps.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.qiji.cps.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.qiji.cps.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import com.qiji.cps.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.qiji.cps.module.trade.framework.order.config.TradeOrderProperties;
import com.qiji.cps.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.qiji.cps.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.qiji.cps.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/qijicode/qiji-mall-uniapp/issues/ICY7SJ
