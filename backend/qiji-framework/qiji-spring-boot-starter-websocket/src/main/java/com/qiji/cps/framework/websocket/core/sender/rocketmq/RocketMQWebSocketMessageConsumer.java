package com.qiji.cps.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${qiji.websocket.sender-rocketmq.topic}",
        consumerGroup = "${qiji.websocket.sender-rocketmq.consumer-group}",
