package com.qiji.cps.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.qiji.cps.framework.common.util.json.JsonUtils;
import com.qiji.cps.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${qiji.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class QijiMybatisAutoConfiguration {
    ...
    public MybatisPlusInterceptor mybatisPlusInterceptor() {
        ...
        // 实体使用 @Version 时，UpdateById 注入的版本条件依赖该拦截器
        // 填充 MP_OPTLOCK_VERSION_ORIGINAL 并推进新版本号。
