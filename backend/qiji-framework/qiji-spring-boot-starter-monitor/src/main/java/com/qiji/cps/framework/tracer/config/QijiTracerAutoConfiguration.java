...
import com.qiji.cps.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "qiji.tracer", value = "enable", matchIfMissing = true)
public class QijiTracerAutoConfiguration {
