package com.qiji.cps.framework.desensitize.core;
...
import com.qiji.cps.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.qiji.cps.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.qiji.cps.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setRegex("你好，我是AgenticCPS源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("AgenticCPS源码");
        ...
        assertEquals("AgenticCPS源码", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "AgenticCPS源码", replacer = "*")
