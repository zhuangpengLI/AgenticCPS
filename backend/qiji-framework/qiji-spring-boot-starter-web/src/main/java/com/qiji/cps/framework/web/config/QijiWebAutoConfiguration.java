package com.qiji.cps.framework.web.config;
...
import com.qiji.cps.framework.web.core.filter.CacheRequestBodyFilter;
import com.qiji.cps.framework.web.core.filter.DemoFilter;
import com.qiji.cps.framework.web.core.handler.GlobalExceptionHandler;
import com.qiji.cps.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class QijiWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "qiji.demo", havingValue = "true")
