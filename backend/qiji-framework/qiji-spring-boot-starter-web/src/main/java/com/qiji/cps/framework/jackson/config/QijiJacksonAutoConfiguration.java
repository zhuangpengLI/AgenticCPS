package com.qiji.cps.framework.jackson.config;

import com.qiji.cps.framework.common.util.json.JsonUtils;
import com.qiji.cps.framework.common.util.json.databind.NumberSerializer;
import com.qiji.cps.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.qiji.cps.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class QijiJacksonAutoConfiguration {
