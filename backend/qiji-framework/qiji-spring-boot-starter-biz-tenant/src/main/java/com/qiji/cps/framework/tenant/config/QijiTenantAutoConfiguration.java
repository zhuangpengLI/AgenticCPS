package com.qiji.cps.framework.tenant.config;

import com.qiji.cps.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.qiji.cps.framework.redis.config.QijiCacheProperties;
import com.qiji.cps.framework.security.core.service.SecurityFrameworkService;
import com.qiji.cps.framework.tenant.core.aop.TenantIgnore;
import com.qiji.cps.framework.tenant.core.aop.TenantIgnoreAspect;
import com.qiji.cps.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.qiji.cps.framework.tenant.core.job.TenantJobAspect;
import com.qiji.cps.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.qiji.cps.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.qiji.cps.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.qiji.cps.framework.tenant.core.redis.TenantRedisCacheManager;
import com.qiji.cps.framework.tenant.core.security.TenantSecurityWebFilter;
import com.qiji.cps.framework.tenant.core.service.TenantFrameworkService;
import com.qiji.cps.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.qiji.cps.framework.tenant.core.web.TenantContextWebFilter;
import com.qiji.cps.framework.tenant.core.web.TenantVisitContextInterceptor;
import com.qiji.cps.framework.web.config.WebProperties;
import com.qiji.cps.framework.web.core.handler.GlobalExceptionHandler;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "qiji.tenant", value = "enable", matchIfMissing = true) // 允许使用 qiji.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class QijiTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     QijiCacheProperties qijiCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(qijiCacheProperties.getRedisScanBatchSize()));
