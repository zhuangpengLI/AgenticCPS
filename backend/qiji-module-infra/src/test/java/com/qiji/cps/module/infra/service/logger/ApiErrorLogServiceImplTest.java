package com.qiji.cps.module.infra.service.logger;
...
import com.qiji.cps.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.qiji.cps.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.qiji.cps.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.qiji.cps.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.qiji.cps.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.qiji.cps.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("qiji-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("qiji-test");
