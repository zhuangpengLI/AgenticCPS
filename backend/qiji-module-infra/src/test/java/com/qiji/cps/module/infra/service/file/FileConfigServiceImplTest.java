package com.qiji.cps.module.infra.service.file;
...
import com.qiji.cps.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.qiji.cps.module.infra.dal.dataobject.file.FileConfigDO;
import com.qiji.cps.module.infra.dal.mysql.file.FileConfigMapper;
import com.qiji.cps.module.infra.framework.file.core.client.FileClient;
import com.qiji.cps.module.infra.framework.file.core.client.FileClientConfig;
import com.qiji.cps.module.infra.framework.file.core.client.FileClientFactory;
import com.qiji.cps.module.infra.framework.file.core.client.local.LocalFileClient;
import com.qiji.cps.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.qiji.cps.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.qiji.cps.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.qiji.cps.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("AgenticCPS源码")
