package com.qiji.cps.module.infra.websocket;
...
import com.qiji.cps.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.qiji.cps.module.infra.websocket.message.DemoReceiveMessage;
import com.qiji.cps.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 qiji.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
