package com.qiji.cps.module.infra.controller.admin.codegen;
...
import com.qiji.cps.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.qiji.cps.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.qiji.cps.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.qiji.cps.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.qiji.cps.module.infra.convert.codegen.CodegenConvert;
...
import com.qiji.cps.module.infra.service.codegen.CodegenService;
...
import static com.qiji.cps.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.qiji.cps.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "qiji"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "AgenticCPS")
    })
