package com.qiji.cps.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.qiji.cps.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "AgenticCPS源码，牛逼！")
    @ExcelProperty("结果提示")
