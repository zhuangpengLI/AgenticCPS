...
import com.qiji.cps.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import com.qiji.cps.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/qiji-cloud/issues/I8SM9H 场景
