package com.qiji.cps.module.mp.service.account;
...
import com.qiji.cps.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.qiji.cps.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.qiji.cps.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.qiji.cps.module.mp.convert.account.MpAccountConvert;
import com.qiji.cps.module.mp.dal.dataobject.account.MpAccountDO;
import com.qiji.cps.module.mp.dal.mysql.account.MpAccountMapper;
import com.qiji.cps.module.mp.enums.ErrorCodeConstants;
...
import static com.qiji.cps.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 qiji-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
