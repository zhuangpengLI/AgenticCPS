...
## 项目结构
项目采用 Maven 多模块架构，顶层聚合工程统一管理版本与插件，核心模块包括 yudao-module-cps（CPS业务模块）、yudao-server（后端服务容器）、以及 yudao-module-system、yudao-module-member、yudao-module-pay、yudao-module-mall、yudao-module-ai、yudao-module-report 等通用模块。CPS模块进一步拆分为 yudao-module-cps-biz（业务实现）与 yudao-module-cps-api（接口定义），并通过 yudao-server 统一打包部署。

```mermaid
graph TB
Root["根工程<br/>yudao(pom)"] --> Server["yudao-server<br/>后端服务容器"]
Root --> CpsModule["yudao-module-cps<br/>CPS模块(POM)"]
Root --> SysModule["yudao-module-system<br/>系统模块"]
Root --> MemberModule["yudao-module-member<br/>会员模块"]
Root --> PayModule["yudao-module-pay<br/>支付模块"]
Root --> MallModule["yudao-module-mall<br/>商城模块"]
Root --> AiModule["yudao-module-ai<br/>AI模块"]
Root --> ReportModule["yudao-module-report<br/>报表模块"]
CpsModule --> CpsBiz["yudao-module-cps-biz<br/>CPS业务实现"]
Server --> SysModule
Server --> MemberModule
Server --> PayModule
Server --> MallModule
...
## 架构总览
系统采用前后端分离与多模块解耦设计，后端通过 yudao-server 聚合并对外提供 RESTful API；CPS业务模块通过统一平台适配层对接各联盟平台，结合会员、支付、基础设施等模块能力，实现完整的CPS闭环。
...
**图表来源**
- [CpsPlatformClient.java:11-66](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/client/CpsPlatformClient.java#L11-L66)
- [CpsPlatformServiceImpl.java:20-98](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsPlatformServiceImpl.java#L20-L98)
...
**图表来源**
- [CpsOrderServiceImpl.java:40-43](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderServiceImpl.java#L40-L43)
- [CpsRebateRecordServiceImpl.java:18-38](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsRebateRecordServiceImpl.java#L18-L38)
...
**章节来源**
- [CpsPlatformServiceImpl.java:66-85](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsPlatformServiceImpl.java#L66-L85)
- [CpsOrderServiceImpl.java:40-43](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderServiceImpl.java#L40-L43)
