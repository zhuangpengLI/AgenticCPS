...
- [pom.xml](file://yudao-module-report/pom.xml)
</cite>
...
**章节来源**
- [CpsMcpAutoConfiguration.java:1-37](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/mcp/CpsMcpAutoConfiguration.java#L1-L37)
- [CpsMcpServer.java:1-126](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/mcp/server/CpsMcpServer.java#L1-L126)
...
**章节来源**
- [CodegenController.java:1-52](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/codegen/CodegenController.java#L1-L52)
- [CodegenServiceImpl.java:1-21](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenServiceImpl.java#L1-L21)

## 模块化架构设计

AgenticCPS采用多模块分层设计，核心位于yudao-module-cps模块，包含API定义与业务实现两大子模块。其模块结构与职责如下：

```mermaid
graph TB
subgraph "AgenticCPS平台"
A["yudao-module-cps<br/>CPS核心模块"]
B["yudao-module-ai<br/>AI智能模块"]
C["yudao-module-infra<br/>基础设施模块"]
D["yudao-module-system<br/>系统管理模块"]
E["yudao-module-member<br/>会员中心模块"]
F["yudao-module-pay<br/>支付系统模块"]
G["yudao-module-report<br/>报表可视化模块"]
H["yudao-module-mall<br/>商城系统模块"]
I["yudao-module-mp<br/>微信公众号模块"]
end
A --> B
A --> C
A --> D
...
- [TenantIgnoreAspect.java:1-41](file://yudao-framework/yudao-spring-boot-starter-biz-tenant/src/main/java/cn/iocoder/yudao/framework/tenant/core/aop/TenantIgnoreAspect.java#L1-L41)
