...
- [CpsPlatformClientFactoryImpl.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/CpsPlatformClientFactoryImpl.java)
...
## 项目结构
AgenticCPS系统采用模块化分层架构，核心能力集中在qiji-module-cps模块，围绕“平台客户端适配层 + 业务服务层 + 控制器层 + 配置与枚举 + DTO与枚举 + 作业调度”的组织方式展开。MCP接口层位于同一模块下，提供AI Agent可调用的Tools与Resources。
