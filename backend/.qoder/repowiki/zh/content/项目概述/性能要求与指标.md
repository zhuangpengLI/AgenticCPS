...
- [org.springframework.boot.autoconfigure.AutoConfiguration.imports](file://qiji-framework/qiji-spring-boot-starter-job/src/main/resources/META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports)
...
- qiji-module-cps：CPS业务域（商品搜索、比价、转链、订单同步、返利结算等）
- qiji-module-trade / qiji-module-pay：交易与支付域（订单、钱包、转账）
- qiji-module-member：会员域（用户、等级、积分等）
- qiji-framework：通用基础设施（定时任务、消息队列、监控、Redis、MyBatis等）
- qiji-server：应用启动与配置
...
**章节来源**
- [CPS系统PRD文档.md:80-120](file://docs/CPS系统PRD文档.md#L80-L120)
- [org.springframework.boot.autoconfigure.AutoConfiguration.imports:1-2](file://qiji-framework/qiji-spring-boot-starter-job/src/main/resources/META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports#L1-L2)
