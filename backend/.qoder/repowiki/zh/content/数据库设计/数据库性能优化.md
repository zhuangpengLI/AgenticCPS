...
- [CpsOrderMapper.java:14-40](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsOrderMapper.java#L14-L40)
- [CpsStatisticsMapper.java:14-30](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsStatisticsMapper.java#L14-L30)
...
## 核心组件
- 订单表（qiji_cps_order）：承载订单生命周期与返利计算的关键表，包含平台编码、会员 ID、订单状态、时间字段等高频过滤与排序字段。
- 统计表（qiji_cps_statistics）：按日聚合的统计数据，支持按日期范围与平台维度查询。
...
- [CpsOrderMapper.java:16-38](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsOrderMapper.java#L16-L38)
- [CpsStatisticsMapper.java:16-28](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsStatisticsMapper.java#L16-L28)
- [CpsOrderDO.java:22-79](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/dataobject/CpsOrderDO.java#L22-L79)
...
**图表来源**
- [CpsOrderService.java:16-18](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderService.java#L16-L18)
...
**章节来源**
- [CpsOrderMapper.java:25-31](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsOrderMapper.java#L25-L31)
- [CpsStatisticsMapper.java:23-27](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsStatisticsMapper.java#L23-L27)
...
## 性能考量
- 热点表与热点字段
  - qiji_cps_order 是核心热点表，需重点优化索引与查询
  - 统计表按天分片，避免写放大
- 写多读少与读多写少
...
## 结论
通过对 CPS 系统核心表 qiji_cps_order 与 qiji_cps_statistics 的索引现状与查询模式进行分析，建议优先完善复合索引、引入覆盖索引、优化慢查询与 SQL 改写，并辅以缓存、连接池与事务优化。对于未来规模增长，应评估分库分表策略与跨分片查询方案，持续以监控与调优工具驱动性能迭代。
