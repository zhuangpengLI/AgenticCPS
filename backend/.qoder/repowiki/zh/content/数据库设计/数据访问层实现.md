...
<cite>
**本文引用的文件**
- [QijiMybatisAutoConfiguration.java](file://qiji-framework/qiji-spring-boot-starter-mybatis/src/main/java/com.qiji.cps/framework/mybatis/config/QijiMybatisAutoConfiguration.java)
- [QijiMybatisAutoConfiguration.java](file://qiji-framework/qiji-spring-boot-starter-mybatis/src/main/resources/META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports)
- [pom.xml](file://qiji-module-cps/qiji-module-cps-biz/pom.xml)
...
- [CpsPlatformClientFactoryImpl.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/client/CpsPlatformClientFactoryImpl.java)
...
## 项目结构
CPS模块采用“controller-service-dal”三层结构，数据访问层位于dal目录下，包含dataobject（实体类）与mysql（Mapper接口）两部分。MyBatis-Plus通过自动配置完成分页插件、字段自动填充、主键生成器等基础设施，CPS模块通过依赖qiji-spring-boot-starter-mybatis获得统一能力。
...
章节来源
- [pom.xml:1-122](file://qiji-module-cps/qiji-module-cps-biz/pom.xml#L1-L122)
...
章节来源
- [QijiMybatisAutoConfiguration.java:23-80](file://qiji-framework/qiji-spring-boot-starter-mybatis/src/main/java/com.qiji.cps/framework/mybatis/config/QijiMybatisAutoConfiguration.java#L23-L80)
- [QijiMybatisAutoConfiguration.java](file://qiji-framework/qiji-spring-boot-starter-mybatis/src/main/resources/META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports)
...
图示来源
- [QijiMybatisAutoConfiguration.java:47-54](file://qiji-framework/qiji-spring-boot-starter-mybatis/src/main/java/com.qiji.cps/framework/mybatis/config/QijiMybatisAutoConfiguration.java#L47-L54)
- [CpsAdzoneServiceImpl.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsAdzoneServiceImpl.java)
- [CpsOrderServiceImpl.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderServiceImpl.java)
...
```mermaid
graph LR
CPS["qiji-module-cps-biz"] --> MYBATIS["qiji-spring-boot-starter-mybatis"]
CPS --> REDIS["qiji-spring-boot-starter-redis"]
CPS --> SECURITY["qiji-spring-boot-starter-security"]
CPS --> VALIDATION["spring-boot-starter-validation"]
CPS --> JOB["qiji-spring-boot-starter-job"]
CPS --> EXCEL["qiji-spring-boot-starter-excel"]
CPS --> SYS["qiji-module-system"]
CPS --> MEMBER["qiji-module-member"]
CPS --> INFRA["qiji-module-infra"]
```

图示来源
- [pom.xml:20-118](file://qiji-module-cps/qiji-module-cps-biz/pom.xml#L20-L118)
...
- 枚举与错误码：[CpsAdzoneTypeEnum.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/enums/CpsAdzoneTypeEnum.java)，[CpsOrderStatusEnum.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/enums/CpsOrderStatusEnum.java)，[ErrorCodeConstants.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/enums/ErrorCodeConstants.java)