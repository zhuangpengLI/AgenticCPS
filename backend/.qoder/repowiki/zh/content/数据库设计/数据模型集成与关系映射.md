...
- 实体类：位于qiji-module-cps-biz模块的dal.dataobject包，对应上述表结构。
...
graph TB
subgraph "数据库层"
T1["qiji_cps_platform<br/>平台配置"]
T2["qiji_cps_adzone<br/>推广位"]
T3["qiji_cps_order<br/>订单"]
T4["qiji_cps_rebate_config<br/>返利配置"]
T5["qiji_cps_rebate_record<br/>返利记录"]
T6["qiji_cps_withdraw<br/>提现"]
T7["qiji_cps_statistics<br/>统计数据"]
T8["qiji_cps_mcp_api_key<br/>MCP API Key"]
T9["qiji_cps_mcp_access_log<br/>MCP访问日志"]
end
subgraph "实体层"
E1["CpsPlatformDO"]
E2["CpsAdzoneDO"]
