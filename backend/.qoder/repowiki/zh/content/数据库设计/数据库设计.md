...
- [CpsPlatformMapper.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsPlatformMapper.java)
...
- 数据访问层：位于 qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal 下，包含实体类与 Mapper 接口
...
- [CpsPlatformDO.java:1-82](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/dataobject/CpsPlatformDO.java#L1-L82)
- [CpsAdzoneDO.java:1-41](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/dataobject/CpsAdzoneDO.java#L1-L41)
...
- 实体类映射
  - 平台配置实体：对应 qiji_cps_platform，字段与建表脚本一致，包含主键、平台编码、名称、密钥、费率、状态、扩展配置等
  - 推广位实体：对应 qiji_cps_adzone，包含平台编码、推广位 ID、类型、关联关系、默认标记、状态等
...
- [CpsPlatformDO.java:1-82](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/dataobject/CpsPlatformDO.java#L1-L82)
- [CpsAdzoneDO.java:1-41](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/dataobject/CpsAdzoneDO.java#L1-L41)
- [CpsPlatformMapper.java:1-25](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsPlatformMapper.java#L1-L25)
- [CpsOrderMapper.java:1-32](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsOrderMapper.java#L1-L32)
- [CpsStatisticsMapper.java:1-30](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsStatisticsMapper.java#L1-L30)
