...
- [PayChannelCreateReqVO.java](file://yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/channel/vo/PayChannelCreateReqVO.java)
- [PayChannelRespVO.java](file://yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/channel/vo/PayChannelRespVO.java)
...
```mermaid
graph TB
Root["根工程<br/>pom.xml"] --> Server["yudao-server"]
Root --> Framework["yudao-framework"]
Root --> Modules["各业务模块"]
Modules --> System["yudao-module-system"]
Modules --> Infra["yudao-module-infra"]
Modules --> Member["yudao-module-member"]
Modules --> Pay["yudao-module-pay"]
Modules --> Mall["yudao-module-mall"]
Modules --> AI["yudao-module-ai"]
Modules --> MP["yudao-module-mp"]
Modules --> Report["yudao-module-report"]
Modules --> CPS["yudao-module-cps"]
CPS --> CPSBiz["yudao-module-cps-biz"]
```
...
- [CpsMcpServer.java:16-87](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/mcp/server/CpsMcpServer.java#L16-L87)
...
- [CpsMcpPrompt.java:9-53](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/mcp/prompt/CpsMcpPrompt.java#L9-L53)
- [PayChannelService.java:18-53](file://yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/service/channel/PayChannelService.java#L18-L53)
...
- [GlobalExceptionHandler.java:413-434](file://yudao-framework/yudao-spring-boot-starter-web/src/main/java/cn/iocoder/yudao/framework/web/core/handler/GlobalExceptionHandler.java#L413-L434)
...
- 依赖关系配置
  - 在根pom中新增模块声明，确保依赖版本由yudao-dependencies统一管理。
...
**图表来源**
- [ConfigServiceImpl.java:97-122](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/config/ConfigServiceImpl.java#L97-L122)
...
- 扩展消息队列
  - 复用yudao-spring-boot-starter-mq，按需引入RabbitMQ/Kafka/RocketMQ等实现。
...
**图表来源**
- [PayChannelService.java:18-53](file://yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/service/channel/PayChannelService.java#L18-L53)
- [PayChannelCreateReqVO.java:15-25](file://yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/channel/vo/PayChannelCreateReqVO.java#L15-L25)
- [PayChannelRespVO.java:11-25](file://yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/channel/vo/PayChannelRespVO.java#L11-L25)
...
- [CpsMcpTool.java:29-30](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/mcp/tool/CpsMcpTool.java#L29-L30)
...
**章节来源**
- [GlobalExceptionHandler.java:413-434](file://yudao-framework/yudao-spring-boot-starter-web/src/main/java/cn/iocoder/yudao/framework/web/core/handler/GlobalExceptionHandler.java#L413-L434)
- [PayChannelCreateReqVO.java:17-23](file://yudao-module-pay/src/main/java/cn/iocoder/yudao/module/pay/controller/admin/channel/vo/PayChannelCreateReqVO.java#L17-L23)
