...
- [CodegenBuilder.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenBuilder.java)
</cite>
...
- [CodegenService.java:14-109](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenService.java#L14-L109)
- [CodegenServiceImpl.java:47-311](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenServiceImpl.java#L47-L311)
- [CodegenEngine.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenEngine.java)
- [CodegenBuilder.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenBuilder.java)
...
- [CodegenTemplateTypeEnum.java:9-54](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/enums/codegen/CodegenTemplateTypeEnum.java#L9-L54)
- [CodegenSceneEnum.java:8-41](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/enums/codegen/CodegenSceneEnum.java#L8-L41)
...
- [CodegenServiceImpl.java:260-298](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenServiceImpl.java#L260-L298)
- [CodegenEngine.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenEngine.java)
...
章节来源
- [CodegenService.java:14-109](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenService.java#L14-L109)
- [CodegenServiceImpl.java:68-311](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenServiceImpl.java#L68-L311)
- [CodegenTemplateTypeEnum.java:9-54](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/enums/codegen/CodegenTemplateTypeEnum.java#L9-L54)
...
图表来源
- [CodegenController.java:46-47](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/codegen/CodegenController.java#L46-L47)
- [CodegenService.java:19-109](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenService.java#L19-L109)
- [CodegenServiceImpl.java:50-66](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenServiceImpl.java#L50-L66)
- [CodegenEngine.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenEngine.java)
- [CodegenBuilder.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/inner/CodegenBuilder.java)
- [CodegenProperties.java:13-59](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/framework/codegen/config/CodegenProperties.java#L13-L59)
- [CodegenTemplateTypeEnum.java:9-54](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/enums/codegen/CodegenTemplateTypeEnum.java#L9-L54)
...
- 代码冲突
  ...
  - 参考
    - [CodegenServiceImpl.java:169-215](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/codegen/CodegenServiceImpl.java#L169-L215)
...
- 步骤1：选择数据源配置
  ...
  - 参考
    - [CodegenController.java:49-62](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/codegen/CodegenController.java#L49-L62)
- 步骤2：选择数据表并创建
  - 调用“批量创建表/字段定义”接口，传入数据源配置编号与表名列表。
  - 参考
    - [CodegenController.java:92-97](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/codegen/CodegenController.java#L92-L97)
- 步骤3：配置生成选项
  - 在表/字段详情中勾选生成选项（如是否批量删除、是否生成单元测试等），并保存。
  - 参考
    - [CodegenController.java:99-105](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/codegen/CodegenController.java#L99-L105)
- 步骤4：执行生成
  - 预览：调用“预览生成代码”接口，查看文件路径与内容列表。
  - 下载：调用“下载生成代码”接口，获取zip压缩包。
  - 参考
    - [CodegenController.java:134-158](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/codegen/CodegenController.java#L134-L158)
...
- 数据库连接配置
  ...
  - 参考
    - [application.yaml:303-309](file://yudao-server/src/main/resources/application.yaml#L303-L309)
- 生成模板选择
...
- 调整代码格式
  ...
  - 参考
    - [CodegenProperties.java:46-56](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/framework/codegen/config/CodegenProperties.java#L46-L56)