...
- [SecurityConfiguration.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/framework/security/config/SecurityConfiguration.java)
...
- 安全自动装配与过滤器注册：YudaoSecurityAutoConfiguration、YudaoWebSecurityConfigurerAdapter
...
graph TB
subgraph "安全框架"
A["YudaoSecurityAutoConfiguration<br/>注册认证入口/过滤器/加密器"]
B["YudaoWebSecurityConfigurerAdapter<br/>构建SecurityFilterChain"]
...
图表来源
- [YudaoSecurityAutoConfiguration.java:32-85](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/config/YudaoSecurityAutoConfiguration.java#L32-L85)
...
- [LoginUser.java:18-76](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/LoginUser.java#L18-L76)
...
- [OAuth2TokenServiceImpl.java:112-136](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/service/oauth2/OAuth2TokenServiceImpl.java#L112-L136)
- [AdminUserServiceImpl.java:538-550](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/service/user/AdminUserServiceImpl.java#L538-L550)
...
- 配置与加密
  ...
  - BCryptPasswordEncoder：在YudaoSecurityAutoConfiguration中注册，用于密码加密
- OAuth2 Token接口与实现
...
- [OAuth2TokenCommonApi.java:14-49](file://yudao-framework/yudao-common/src/main/java/cn/iocoder/yudao/framework/common/biz/system/oauth2/OAuth2TokenCommonApi.java#L14-L49)
- [OAuth2TokenServiceImpl.java:112-136](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/service/oauth2/OAuth2TokenServiceImpl.java#L112-L136)
- [YudaoSecurityAutoConfiguration.java:43-65](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/config/YudaoSecurityAutoConfiguration.java#L43-L65)

## 架构总览
AgenticCPS采用“无状态Token + Spring Security过滤器链”的认证架构：
- 请求进入时，YudaoWebSecurityConfigurerAdapter构建SecurityFilterChain，禁用CSRF与Session，开启跨域与异常处理
...
- [SecurityFrameworkUtils.java:41-133](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/util/SecurityFrameworkUtils.java#L41-L133)
- [OAuth2TokenServiceImpl.java:131-136](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/service/oauth2/OAuth2TokenServiceImpl.java#L131-L136)
...
章节来源
- [LoginUser.java:18-76](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/LoginUser.java#L18-L76)
- [SecurityFrameworkUtils.java:74-114](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/util/SecurityFrameworkUtils.java#L74-L114)
...
### 密码加密机制（BCryptPasswordEncoder）
- 在YudaoSecurityAutoConfiguration中注册BCryptPasswordEncoder，并使用SecurityProperties.passwordEncoderLength控制加密复杂度
...
图表来源
- [OAuth2TokenCommonApi.java:22-47](file://yudao-framework/yudao-common/src/main/java/cn/iocoder/yudao/framework/common/biz/system/oauth2/OAuth2TokenCommonApi.java#L22-L47)
- [OAuth2TokenServiceImpl.java:112-136](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/service/oauth2/OAuth2TokenServiceImpl.java#L112-L136)
...
章节来源
- [OAuth2TokenCommonApi.java:22-30](file://yudao-framework/yudao-common/src/main/java/cn/iocoder/yudao/framework/common/biz/system/oauth2/OAuth2TokenCommonApi.java#L22-L30)
...
- [AuthenticationEntryPointImpl.java:28-33](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/handler/AuthenticationEntryPointImpl.java#L28-33)
- [AccessDeniedHandlerImpl.java:31-39](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/handler/AccessDeniedHandlerImpl.java#L31-39)

## 依赖关系分析
- 自动装配层：YudaoSecurityAutoConfiguration注册AuthenticationEntryPoint、AccessDeniedHandler、PasswordEncoder、TokenAuthenticationFilter与SecurityFrameworkService
- 安全配置层：YudaoWebSecurityConfigurerAdapter构建SecurityFilterChain，禁用CSRF与Session，配置免登录URL与异常处理，插入TokenAuthenticationFilter
...
```mermaid
graph LR
Auto["YudaoSecurityAutoConfiguration"] --> Chain["YudaoWebSecurityConfigurerAdapter"]
...
图表来源
- [YudaoSecurityAutoConfiguration.java:43-79](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/config/YudaoSecurityAutoConfiguration.java#L43-79)
- [YudaoWebSecurityConfigurerAdapter.java:110-153](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/config/YudaoWebSecurityConfigurerAdapter.java#L110-L153)
...
- [SecurityFrameworkUtils.java:122-133](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/util/SecurityFrameworkUtils.java#L122-L133)
- [OAuth2TokenCommonApi.java:14-49](file://yudao-framework/yudao-common/src/main/java/cn/iocoder/yudao/framework/common/biz/system/oauth2/OAuth2TokenCommonApi.java#L14-L49)
- [OAuth2TokenServiceImpl.java:112-136](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/service/oauth2/OAuth2TokenServiceImpl.java#L112-L136)
- [AuthenticationEntryPointImpl.java:26-35](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/handler/AuthenticationEntryPointImpl.java#L26-L35)
- [AccessDeniedHandlerImpl.java:29-41](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/core/handler/AccessDeniedHandlerImpl.java#L29-L41)
...
章节来源
- [YudaoWebSecurityConfigurerAdapter.java:112-119](file://yudao-framework/yudao-spring-boot-starter-security/src/main/java/cn/iocoder/yudao/framework/security/config/YudaoWebSecurityConfigurerAdapter.java#L112-L119)
...
- [OAuth2TokenServiceImpl.java:112-127](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/service/oauth2/OAuth2TokenServiceImpl.java#L112-L127)
...
- 配置参数（SecurityProperties）
  - yudao.security.token-header：HTTP请求头中Token的键名，默认“Authorization”
  - yudao.security.token-parameter：HTTP请求参数中Token的键名，默认“token”
  - yudao.security.permit-all-urls：免登录URL列表
  - yudao.security.mock-enable：mock模式开关
  - yudao.security.mock-secret：mock密钥
  - yudao.security.password-encoder-length：BCrypt加密复杂度
- 最佳实践
  - 生产环境务必关闭mock模式
  - 合理设置Token有效期与刷新策略
  - 对敏感接口启用权限校验与数据权限控制
