...
- [yudao-ui-admin-vue3/README.md](file://yudao-ui-admin-vue3/README.md)
- [yudao-ui-admin-uniapp/README.md](file://yudao-ui-admin-uniapp/README.md)
- [yudao-ui-mall-uniapp/README.md](file://yudao-ui-mall-uniapp/README.md)
</cite>
...
## 项目结构
根据仓库信息，前端相关模块以“yudao-ui”命名空间组织，包含：
- yudao-ui-admin-vue3：基于 Vue3 + Element Plus 的管理后台 PC 端前端
- yudao-ui-admin-uniapp：基于 UniApp 的管理后台移动端（APP/小程序/H5）
- yudao-ui-mall-uniapp：基于 UniApp 的商城移动端（APP/小程序/H5）

上述模块均提供独立的 README 作为使用说明与运行指引。

```mermaid
graph TB
A["AgenticCPS 前端架构"] --> B["yudao-ui-admin-vue3<br/>Vue3 + Element Plus 管理后台(PC)"]
A --> C["yudao-ui-admin-uniapp<br/>UniApp 管理后台(移动端)"]
A --> D["yudao-ui-mall-uniapp<br/>UniApp 商城(移动端)"]
