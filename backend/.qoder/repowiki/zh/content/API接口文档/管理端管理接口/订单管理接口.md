...
## 项目结构
CPS订单管理位于 qiji-module-cps 子模块中，采用典型的分层架构：
- 控制器层：对外暴露HTTP接口
- 业务层：封装订单同步、查询、状态更新等核心逻辑
- 数据访问层：MyBatis映射数据库表 qiji_cps_order
...
- [CpsOrderServiceImpl.java:24-235](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderServiceImpl.java#L24-L235)
...
- [CpsOrderDTO.java:8-79](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/client/dto/CpsOrderDTO.java#L8-L79)
...
- [CpsOrderStatusEnum.java:6-30](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/enums/CpsOrderStatusEnum.java#L6-L30)
...
- 数据对象：映射 qiji_cps_order 表，包含订单基础信息、佣金、返利、状态、时间戳等
...
章节来源
- [CpsOrderStatusEnum.java:6-30](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/enums/CpsOrderStatusEnum.java#L6-L30)
- [CpsOrderServiceImpl.java:176-194](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderServiceImpl.java#L176-L194)
...
- [CpsOrderServiceImpl.java:200-232](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderServiceImpl.java#L200-L232)
