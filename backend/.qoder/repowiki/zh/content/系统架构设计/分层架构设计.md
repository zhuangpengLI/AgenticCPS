...
- [CpsAdzoneMapper.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsAdzoneMapper.java)
...
## 项目结构
AgenticCPS 位于 qiji-module-cps 模块中，采用“模块聚合 + 子模块业务域”的组织方式。其中 qiji-module-cps-biz 为业务子模块，包含 controller、service、dal、enums、job、client、mcp 等包，体现清晰的分层与领域划分。

```mermaid
graph TB
subgraph "CPS 模块"
A["qiji-module-cps<br/>聚合模块"]
B["qiji-module-cps-biz<br/>业务子模块"]
end
A --> B
...
图表来源
- [pom.xml:1-25](file://qiji-module-cps/pom.xml#L1-L25)
...
章节来源
- [CpsAdzoneController.java:1-73](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/controller/admin/CpsAdzoneController.java#L1-L73)
- [CpsAdzoneServiceImpl.java:1-79](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsAdzoneServiceImpl.java#L1-L79)
- [CpsAdzoneMapper.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsAdzoneMapper.java)
...
- [CpsAdzoneServiceImpl.java:29-33](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsAdzoneServiceImpl.java#L29-L33)
- [CommonResult.java](file://qiji-framework/qiji-common/src/main/java/com.qiji.cps/framework/common/pojo/CommonResult.java)
...
图表来源
- [CpsAdzoneServiceImpl.java:68-76](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsAdzoneServiceImpl.java#L68-L76)
- [ErrorCodeConstants.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/enums/ErrorCodeConstants.java)
...
图表来源
- [CpsAdzoneServiceImpl.java:25-61](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsAdzoneServiceImpl.java#L25-L61)
- [CpsAdzoneMapper.java](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/dal/mysql/CpsAdzoneMapper.java)
...
图表来源
- [CpsAdzoneController.java:64-70](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/controller/admin/CpsAdzoneController.java#L64-L70)
- [CpsAdzoneServiceImpl.java:58-61](file://qiji-module-cps/qiji-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsAdzoneServiceImpl.java#L58-L61)
- [PageResult.java](file://qiji-framework/qiji-common/src/main/java/com.qiji.cps/framework/common/pojo/PageResult.java)
