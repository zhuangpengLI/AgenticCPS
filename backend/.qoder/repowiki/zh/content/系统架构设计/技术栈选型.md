...
- [qiji-server/src/main/resources/application-dev.yaml](file://qiji-server/src/main/resources/application-dev.yaml)
...
- [qiji-framework/qiji-spring-boot-starter-monitor/《芋道 Spring Boot 链路追踪 SkyWalking 入门》.md](file://qiji-framework/qiji-spring-boot-starter-monitor/《芋道 Spring Boot 链路追踪 SkyWalking 入门》.md)
- [qiji-framework/qiji-spring-boot-starter-mybatis/《芋道 Spring Boot MyBatis 入门》.md](file://qiji-framework/qiji-spring-boot-starter-mybatis/《芋道 Spring Boot MyBatis 入门》.md)
- [qiji-framework/qiji-spring-boot-starter-security/《芋道 Spring Boot 安全框架 Spring Security 入门》.md](file://qiji-framework/qiji-spring-boot-starter-security/《芋道 Spring Boot 安全框架 Spring Security 入门》.md)
- [qiji-framework/qiji-spring-boot-starter-mq/《芋道 Spring Boot 消息队列 RocketMQ 入门》.md](file://qiji-framework/qiji-spring-boot-starter-mq/《芋道 Spring Boot 消息队列 RocketMQ 入门》.md)
</cite>
...
```mermaid
graph TB
A["父工程<br/>pom.xml"] --> B["qiji-dependencies<br/>BOM 依赖管理"]
A --> C["qiji-server<br/>应用聚合模块"]
A --> D["qiji-framework<br/>通用能力封装"]
A --> E["qiji-module-*<br/>业务模块"]
E --> E1["qiji-module-system"]
E --> E2["qiji-module-infra"]
E --> E3["qiji-module-member"]
E --> E4["qiji-module-pay"]
E --> E5["qiji-module-mall"]
E --> E6["qiji-module-ai"]
E --> E7["qiji-module-cps"]
```
...
- [qiji-dependencies/pom.xml:174-260](file://qiji-dependencies/pom.xml#L174-L260)
- [qiji-dependencies/pom.xml:324-388](file://qiji-dependencies/pom.xml#L324-L388)
- [qiji-dependencies/pom.xml:431-442](file://qiji-dependencies/pom.xml#L431-L442)
- [qiji-server/src/main/resources/application.yaml:55-65](file://qiji-server/src/main/resources/application.yaml#L55-L65)
- [qiji-server/src/main/resources/application.yaml:90-100](file://qiji-server/src/main/resources/application.yaml#L90-L100)
- [qiji-server/src/main/resources/application.yaml:120-145](file://qiji-server/src/main/resources/application.yaml#L120-L145)
- [qiji-server/src/main/resources/application.yaml:146-257](file://qiji-server/src/main/resources/application.yaml#L146-L257)
...
- 集成要点
  - 通过 qiji-dependencies 统一管理 Spring Boot 版本，确保子模块一致性。
...
- 集成方式
  - 通过 qiji-spring-boot-starter-mybatis 自动装配，结合 Druid 连接池与动态数据源。
...
QijiMybatisAutoConfiguration --> DruidDataSource : "使用"
QijiMybatisAutoConfiguration --> DynamicDatasource : "可选"
```
...
- [qiji-dependencies/pom.xml:174-260](file://qiji-dependencies/pom.xml#L174-L260)
- [qiji-server/src/main/resources/application.yaml:66-82](file://qiji-server/src/main/resources/application.yaml#L66-L82)
- [qiji-framework/qiji-spring-boot-starter-mybatis/《芋道 Spring Boot MyBatis 入门》.md:1-2](file://qiji-framework/qiji-spring-boot-starter-mybatis/《芋道 Spring Boot MyBatis 入门》.md#L1-L2)

### Spring Security 安全框架
- 选型理由
  - 提供认证、授权、防护（CSRF、CORS）、审计与操作日志等一体化安全能力。
- 集成方式
  - 通过 qiji-spring-boot-starter-security 自动装配，结合业务模块的安全配置。
- 最佳实践
...
**图表来源**
- [qiji-dependencies/pom.xml:130-150](file://qiji-dependencies/pom.xml#L130-L150)
- [qiji-framework/qiji-spring-boot-starter-security/《芋道 Spring Boot 安全框架 Spring Security 入门》.md:1-3](file://qiji-framework/qiji-spring-boot-starter-security/《芋道 Spring Boot 安全框架 Spring Security 入门》.md#L1-L3)
...
**图表来源**
- [qiji-dependencies/pom.xml:324-388](file://qiji-dependencies/pom.xml#L324-L388)
- [qiji-framework/qiji-spring-boot-starter-monitor/《芋道 Spring Boot 链路追踪 SkyWalking 入门》.md:1-2](file://qiji-framework/qiji-spring-boot-starter-monitor/《芋道 Spring Boot 链路追踪 SkyWalking 入门》.md#L1-L2)
...
**章节来源**
- [qiji-dependencies/pom.xml:293-304](file://qiji-dependencies/pom.xml#L293-L304)
- [qiji-server/src/main/resources/application.yaml:120-145](file://qiji-server/src/main/resources/application.yaml#L120-L145)
- [qiji-framework/qiji-spring-boot-starter-mq/《芋道 Spring Boot 消息队列 RocketMQ 入门》.md:1-2](file://qiji-framework/qiji-spring-boot-starter-mq/《芋道 Spring Boot 消息队列 RocketMQ 入门》.md#L1-L2)

### 缓存与分布式能力（Redis/Redisson）
- 选型理由
  - Redis 提供高性能缓存与会话存储；Redisson 提供分布式锁、限流、布隆过滤器等。
- 集成方式
  - 通过 qiji-spring-boot-starter-redis 与 redisson-spring-boot-starter 自动装配。
  - application.yaml 中配置缓存 TTL、连接参数与 Redisson 基础配置。
- 最佳实践
  - 合理设置过期策略与淘汰策略，避免缓存雪崩与热点 key。

**章节来源**
- [qiji-dependencies/pom.xml:244-260](file://qiji-dependencies/pom.xml#L244-L260)
- [qiji-server/src/main/resources/application.yaml:90-100](file://qiji-server/src/main/resources/application.yaml#L90-L100)
...
**章节来源**
- [qiji-server/src/main/resources/application-local.yaml:33-50](file://qiji-server/src/main/resources/application-local.yaml#L33-L50)
- [qiji-server/src/main/resources/application-dev.yaml:36-54](file://qiji-server/src/main/resources/application-dev.yaml#L36-L54)
...
## 依赖分析
- 版本管理
  - 通过 qiji-dependencies/pom.xml 的 dependencyManagement 统一管理 Spring Boot、MyBatis Plus、Flowable、SkyWalking、RocketMQ 等核心依赖版本。
- 模块依赖
  - qiji-module-cps-biz 明确依赖 system/member/infra 三大基础模块与安全、MyBatis、Redis、Job、Excel 等通用能力。
- 外部依赖
  - MySQL Connector/J、Redisson、Knife4j、SpringDoc、OkHttp 等工具类与 HTTP 客户端均在 BOM 中统一版本。

```mermaid
graph LR
BOM["qiji-dependencies/BOM"] --> SB["Spring Boot"]
BOM --> MB["MyBatis Plus"]
BOM --> FL["Flowable"]
BOM --> SW["SkyWalking"]
BOM --> RMQ["RocketMQ"]
...
CPS["qiji-module-cps-biz"] --> SYS["qiji-module-system"]
CPS --> MEM["qiji-module-member"]
CPS --> INF["qiji-module-infra"]
CPS --> SEC["Security"]
CPS --> MYB["MyBatis"]
CPS --> RED["Redis"]
CPS --> JOB["Job"]
...
- [qiji-module-cps/qiji-module-cps-biz/pom.xml:20-119](file://qiji-module-cps/qiji-module-cps-biz/pom.xml#L20-L119)
