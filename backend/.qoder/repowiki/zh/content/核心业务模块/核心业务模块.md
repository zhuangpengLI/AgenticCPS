...
- [MemberLevelApi.java](file://yudao-module-member/src/main/java/cn/iocoder/yudao/module/member/api/level/MemberLevelApi.java)
...
- [InfraConfigApi.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/api/config/ConfigApi.java)
- [InfraJobApi.java](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/api/job/JobApi.java)
</cite>
...
## 项目结构
AgenticCPS基于多模块架构，核心业务集中在yudao-module-cps，同时复用yudao-module-member（会员）、yudao-module-pay（支付）、yudao-module-infra（基础设施）等模块能力，形成“核心业务 + 复用模块”的清晰边界。
...
subgraph "复用模块"
MEMBER["会员中心模块<br/>yudao-module-member"]
PAY["支付系统模块<br/>yudao-module-pay"]
...
- [CpsPlatformService.java:1-28](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsPlatformService.java#L1-L28)
- [CpsOrderService.java:1-21](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsOrderService.java#L1-L21)
...
**章节来源**
- [CpsPlatformService.java:25](file://yudao-module-cps/yudao-module-cps-biz/src/main/java/cn/zhijian/cps/service/CpsPlatformService.java#L25)
