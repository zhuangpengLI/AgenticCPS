...
- yudao-server：应用启动与配置，包含连接池配置样例
- yudao-module-infra：定时任务、作业调度、监控与运维相关能力
- yudao-module-system：登录日志、操作日志等审计能力
...
graph TB
subgraph "应用层"
server["yudao-server<br/>应用启动与配置"]
infra["yudao-module-infra<br/>定时任务/作业调度"]
system["yudao-module-system<br/>审计日志"]
end
subgraph "数据库层"
mysql["MySQL 实例"]
dm["达梦数据库"]
...
图示来源
- [application-local.yaml:33-50](file://yudao-server/src/main/resources/application-local.yaml#L33-L50)
...
章节来源
- [application-local.yaml:33-50](file://yudao-server/src/main/resources/application-local.yaml#L33-L50)
- [JobSaveReqVO.java:19-40](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/job/vo/job/JobSaveReqVO.java#L19-L40)
- [JobServiceImpl.java:72-91](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/job/JobServiceImpl.java#L72-L91)
- [LoginLogController.java:1-26](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/controller/admin/logger/LoginLogController.java#L1-L26)
...
章节来源
- [JobSaveReqVO.java:1-41](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/job/vo/job/JobSaveReqVO.java#L1-L41)
- [JobServiceImpl.java:64-91](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/job/JobServiceImpl.java#L64-L91)
- [quartz.sql:15-45](file://sql/kingbase/quartz.sql#L15-L45)
...
## 附录
- 关键配置参考
  - 连接池参数：[application-local.yaml:33-50](file://yudao-server/src/main/resources/application-local.yaml#L33-L50)
  - 作业配置模型：[JobSaveReqVO.java:1-41](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/controller/admin/job/vo/job/JobSaveReqVO.java#L1-L41)
  - 作业服务实现：[JobServiceImpl.java:64-91](file://yudao-module-infra/src/main/java/cn/iocoder/yudao/module/infra/service/job/JobServiceImpl.java#L64-L91)
  - 登录日志控制器：[LoginLogController.java:1-26](file://yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/controller/admin/logger/LoginLogController.java#L1-L26)
