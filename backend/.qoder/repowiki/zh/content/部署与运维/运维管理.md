...
- 后端服务：qiji-server，提供REST API与业务能力
- 前端管理界面：qiji-ui-admin-vue3
- 数据库：MySQL（容器化）
- 缓存：Redis（容器化）
- CI/CD：Jenkins流水线
...
graph TB
subgraph "容器编排"
S["qiji-server<br/>端口 48080"]
M["MySQL<br/>端口 3306"]
R["Redis<br/>端口 6379"]
end
subgraph "前端"
A["qiji-ui-admin-vue3<br/>端口 8080"]
end
A --> S
S --> M
S --> R
...
participant Server as "qiji-server"
...
QijiTracerAutoConfiguration --> QijiTracerAutoConfiguration : "注册TraceFilter"
```
