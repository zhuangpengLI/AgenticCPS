...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.qiji.cps";
    private static final String ARTIFACT_ID = "qiji";
    private static final String PACKAGE_NAME = "com.qiji.cps";
    private static final String TITLE = "AgenticCPS管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.qiji.cps";
        String artifactIdNew = "qiji";
        String packageNameNew = "com.qiji.cps";
        String titleNew = "AgenticCPS管理系统";
