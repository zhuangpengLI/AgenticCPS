package com.qiji.cps.module.system.service.tenant;
...
import com.qiji.cps.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.qiji.cps.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.qiji.cps.module.system.dal.dataobject.permission.MenuDO;
import com.qiji.cps.module.system.dal.dataobject.permission.RoleDO;
import com.qiji.cps.module.system.dal.dataobject.tenant.TenantDO;
import com.qiji.cps.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.qiji.cps.module.system.dal.mysql.tenant.TenantMapper;
import com.qiji.cps.module.system.enums.permission.RoleCodeEnum;
import com.qiji.cps.module.system.enums.permission.RoleTypeEnum;
import com.qiji.cps.module.system.service.permission.MenuService;
import com.qiji.cps.module.system.service.permission.PermissionService;
import com.qiji.cps.module.system.service.permission.RoleService;
import com.qiji.cps.module.system.service.tenant.handler.TenantInfoHandler;
import com.qiji.cps.module.system.service.tenant.handler.TenantMenuHandler;
import com.qiji.cps.module.system.service.user.AdminUserService;
...
import static com.qiji.cps.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("AgenticCPS", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("AgenticCPS"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("AgenticCPS");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
