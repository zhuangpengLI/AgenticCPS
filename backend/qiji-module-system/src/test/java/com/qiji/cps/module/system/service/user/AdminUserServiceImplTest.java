package com.qiji.cps.module.system.service.user;
...
import com.qiji.cps.framework.common.util.collection.ArrayUtils;
...
import com.qiji.cps.module.infra.api.config.ConfigApi;
import com.qiji.cps.module.infra.api.file.FileApi;
import com.qiji.cps.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.qiji.cps.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.qiji.cps.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.qiji.cps.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.qiji.cps.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.qiji.cps.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.qiji.cps.module.system.dal.dataobject.dept.DeptDO;
import com.qiji.cps.module.system.dal.dataobject.dept.PostDO;
import com.qiji.cps.module.system.dal.dataobject.dept.UserPostDO;
import com.qiji.cps.module.system.dal.dataobject.tenant.TenantDO;
import com.qiji.cps.module.system.dal.dataobject.user.AdminUserDO;
import com.qiji.cps.module.system.dal.mysql.dept.UserPostMapper;
import com.qiji.cps.module.system.dal.mysql.user.AdminUserMapper;
import com.qiji.cps.module.system.enums.common.SexEnum;
import com.qiji.cps.module.system.service.dept.DeptService;
import com.qiji.cps.module.system.service.dept.PostService;
import com.qiji.cps.module.system.service.oauth2.OAuth2TokenService;
import com.qiji.cps.module.system.service.permission.PermissionService;
...
import static com.qiji.cps.framework.common.util.collection.SetUtils.asSet;
import static com.qiji.cps.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.qiji.cps.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.qiji.cps.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.qiji.cps.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.qiji.cps.framework.test.core.util.AssertUtils.assertServiceException;
import static com.qiji.cps.framework.test.core.util.RandomUtils.*;
import static com.qiji.cps.module.system.enums.ErrorCodeConstants.*;
import static com.qiji.cps.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("qijiyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("qijiyuanma");
        ...
        assertEquals("qijiyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("qijiyuanma"))).thenReturn("java");
