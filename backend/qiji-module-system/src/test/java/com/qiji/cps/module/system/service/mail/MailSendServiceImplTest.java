...
import com.qiji.cps.module.system.mq.message.mail.MailSendMessage;
import com.qiji.cps.module.system.mq.producer.mail.MailProducer;
...
//                .setFrom("奥特曼 <ydym_test@163.com>")
    ...
    public void testSendSingleMail_successWhenMailTemplateEnable() {
        ...
        // 调用
        Long resultMailLogId = mailSendService.sendSingleMail(toMails, null, null, userId, userType, templateCode, templateParams, (File[]) null);
        // 断言
        assertEquals(mailLogId, resultMailLogId);
        // 断言调用
        verify(mailProducer).sendMailSendMessage(eq(mailLogId),
