...
import com.qiji.cps.module.system.controller.admin.tenant.vo.tenant.TenantRespVO;
...
public class TenantController {
    ...
    public CommonResult<TenantRespVO> getTenantByWebsite(
            @RequestParam("website") @Pattern(regexp = "^[a-zA-Z0-9.-]+(?::[0-9]{1,5})?$",
                    message = "网站域名格式不正确") String website) {
