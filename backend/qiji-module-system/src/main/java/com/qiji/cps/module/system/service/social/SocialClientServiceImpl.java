package com.qiji.cps.module.system.service.social;
...
import com.qiji.cps.framework.common.util.cache.CacheUtils;
import com.qiji.cps.framework.common.util.http.HttpUtils;
import com.qiji.cps.framework.common.util.object.BeanUtils;
import com.qiji.cps.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.qiji.cps.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.qiji.cps.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.qiji.cps.module.system.dal.dataobject.social.SocialClientDO;
import com.qiji.cps.module.system.dal.mysql.social.SocialClientMapper;
import com.qiji.cps.module.system.dal.redis.RedisKeyConstants;
import com.qiji.cps.module.system.enums.social.SocialTypeEnum;
import com.qiji.cps.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.qiji.cps.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.qiji.cps.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${qiji.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${qiji.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/qiji-cloud/pulls/230
