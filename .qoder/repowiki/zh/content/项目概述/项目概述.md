...
- [登录 API](file://frontend/admin-uniapp/src/api/login.ts)
- [地区 API](file://frontend/admin-uniapp/src/api/system/area/index.ts)
- [用户 API](file://frontend/admin-vue3/src/api/system/user/index.ts)
</cite>

## 更新摘要
**所做更改**
- 更新了 README.md 中的演示图片格式，将部分 .png 格式更正为 .jpg 格式以确保正确显示
- 修复了前端 API 文件注释中的中文字符编码问题，统一了推广位相关术语表达
- 修正了平台列表注释的表述一致性，改善了退款回扣相关注释的准确性
...
### 前端 API 注释优化
**更新** 修复了前端 API 文件中的中文字符编码问题，统一了推广位相关术语表达，修正了平台列表注释的一致性问题

**章节来源**
- [登录 API:1-149](file://frontend/admin-uniapp/src/api/login.ts#L1-L149)
- [地区 API:1-20](file://frontend/admin-uniapp/src/api/system/area/index.ts#L1-L20)
- [用户 API:1-82](file://frontend/admin-vue3/src/api/system/user/index.ts#L1-L82)

### 演示图片格式修正
**更新** 将 README.md 中的部分演示图片格式从 .png 更正为 .jpg，确保图片在不同环境下正确显示

**章节来源**
- [AgenticCPS 项目总览:422-447](file://README.md#L422-L447)